...
export type MeQuery = { __typename?: 'Query', me: { __typename?: 'User', authUserId: string, enrollments: Array<{ __typename?: 'Enrollment', id: string, createdAt: any, course: { __typename?: 'Course', id: string, title: string, slug: string } }>, purchases: Array<{ __typename?: 'Purchase', id: string, status: PurchaseStatus, createdAt: any, product: { __typename?: 'Product', id: string, title: string } }> } };
