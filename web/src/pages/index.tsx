                    ...
                    <main>
                        ...
                        <div className="relative bg-white py-16 sm:py-24 lg:py-32">
                            <div
                                ...
                                <h2 className="text-base font-semibold tracking-wider text-cyan-600 uppercase">Tudo que
                                    você precisa</h2>
                                        ...
                                        <blockquote>
                                            <div>
                                                ...
                                                <p className="mt-6 text-2xl font-medium text-white">
                                                    ...
                                                    meus próprios projetos pessoais, trabalhar na empresa dos meus
                                                    sonhos e avistar os próximos passos da minha carreira.
                                                </p>
                                            </div>
                                            <footer className="mt-6">
                                                <p className="text-base font-medium text-white">Carolina Torres</p>
                                                <p className="text-base font-medium text-cyan-100">Software Engineer @
                                                    EmpresaDosSonhos</p>
                                            </footer>
                                        </blockquote>
                                    </div>
                        ...
                        <div className="relative bg-gray-50 py-16 sm:py-24 lg:py-32">
                            <div className="relative">
                                <div
                                    ...
                                    <h2 className="text-base font-semibold tracking-wider text-cyan-600 uppercase">Aprenda
                                        mais</h2>
                                    <p className="mt-2 text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">
                                                    ...
                                                    <div className="flex-shrink-0">
                                                        <a href={post.author.href}>
                                                            <img className="h-10 w-10 rounded-full"
                                                                 src={post.author.imageUrl} alt={post.author.name}/>
                                                        </a>
                                                    </div>
                                                    <div className="ml-3">
